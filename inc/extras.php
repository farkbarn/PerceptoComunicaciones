...
function shapely_footer_info() {
  printf( esc_html__( 'Theme by %1$s Powered by %2$s', 'shapely' ) , '<a href="http://www.obconsorcio.com/" target="_blank" title="OB Consorcio">OB Consorcio</a>', '<a href="http://wordpress.org/" target="_blank" title="WordPress.org">WordPress</a>');
}
